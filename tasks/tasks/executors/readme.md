...
Реализуйте и используйте спинлок. В критической секции этого спинлока должна выполняться константная работа.
...
Реализуйте [интрузивные задачи](intrusive.md) и избавьтесь от динамических аллокаций при планировании файберов.
